...
def parse_to_active_cubes(message):
    ...
    for line in lines:
        ...
        for c in line:
            ...
            if c == '.':
                continue
            active_cubes.add((x_coord, y_coord, 0))
    return active_cubes
...
def process_cycle(active_cubes):
    ...
    def capture_new_cube_state(x, y, z):
        is_active = (x,y,z) in active_cubes
        active_adjacent = count_adjacent_active(active_cubes, (x,y,z))
